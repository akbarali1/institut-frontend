export default {
  ...
  registration_credentials : 'Tizim talablari:</br>' + '– kartaga SMS-xabarnoma xizmati ulangan bo’lishi;<br/>' + '– oxirgi 3 oy davomida kartadagi ish haqi barqaror tushgan bo’lishi.',
  registration_details     : 'Pasport skanini va selfi fotosuratini yuklashdan oldin quyidagilarga ishonch hosil qiling:' + '<ul>' + '<li>pasport skani hujjatning aslidan olinganligiga <strong>(kseronusxasi qabul qilinmaydi)</strong>;</li>' + '<li>pasport skani rangli ekanligiga;</li>' + '<li>skanerlash va selfiga olish chog’ida pasport sahifasi to’liq hamda barmoqlar bilan yopilmaganligiga;</li>' + '<li>suratga olish paytida yarqiragan joylari yoqligiga.</li>' + '</ul>',
  ...
  error                    : {
    timeout: "Истекло время ожидания, пожалуйста проверьте Интернет соединение и повторите попытку.", request_error: "Возникла ошибка при выполнении запроса. Повторите попытку и сообщите о проблеме в call-центр +998 55 500 7 500", unknown_error: "Возникла ошибка при выполнении запроса. Повторите попытку и сообщите о проблеме в call-центр +998 55 500 7 500",
  },
  titles                   : {
    my_orders       : 'Buyurtmalarim', my_profile: "Profilim", new_order: "Yangi buyurtma", new_order_client: 'Yangi buyurtma, foydalanuvchi {username}', product: 'Mahsulot', order: 'Buyurtma #{order_id}', order_status: 'Holati: <span>{status}</span>', order_status_canceled: 'Bekor qilingan', // -1 - canceled, 0 - new, 1 - approving, 2 - approved
    order_status_new: 'Yangi', order_status_approving: 'Ko\'rib chiqilmoqda', order_status_approved: "To'langan", balance: 'Balans', payment_graph: "To'lov jadvali",
  },
  quantity                 : 'Soni',
  ...
  how_to                   : {
    selfie: "Qanday qilib pasport bilan selfi qilish kerak", selfie_text: "Siz mijozning fotosuratini yuklashingiz zarur.<br/>Fotosurat aniq, to'g'ri va mijoz qo'lida ochiq pasport bilan selfi uslubida bo'lishi lozim.<br/>Fotosurat hajmi 5 MB dan oshmasligi kerak.",
  },
  loading                  : "Yuklanmoqda...",
